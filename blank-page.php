...
<!-- Mirrored from www.konnectplugins.com/proclinic/Vertical/blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 May 2019 22:55:19 GMT -->
<head>
	<meta charset="utf-8">
			...
			<ul class="list-unstyled components">
				<li>
					...
					<ul class="collapse list-unstyled" id="nav-dashboard">
						...
						<li>
							<a href="http://www.konnectplugins.com/proclinic/Vertical-RTL/index.html">Vertical RTL</a>
						</li>
						<li>
							<a href="http://www.konnectplugins.com/proclinic/Horizontal/index.html">Horizantal</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li class="active">
					<a href="#nav-pages" data-toggle="collapse" aria-expanded="true">
						<span class="ti-file"></span> Other Pages
					</a>
					<ul class="collapse list-unstyled show" id="nav-pages">
						<li>
