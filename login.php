...
<!-- Mirrored from www.konnectplugins.com/proclinic/Vertical/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 May 2019 22:55:19 GMT -->
<head>
	<style>
		p{
			margin-left:700px;
					...
					<div class="col-sm-6 auth-box">
						<div class="proclinic-box-shadow">
							...
							<form class="widget-form" method="post" action="">
								...
								<div class="form-group row">
									<div class="col-sm-12">
										<input type="password" placeholder="Password"  class="form-control" data-validation="strength" data-validation-strength="2"
										 data-validation-has-keyup-event="true" name="password">
									</div>
								</div>
								<!-- /.form-group -->
								<!-- Check Box -->		
								...
								<div class="auth-footer-text">
									<small>New User,
										<a href="sign-up.php">Sign Up</a> Here</small>
								</div>
								<!-- /Links -->
							</form>
						</div>
