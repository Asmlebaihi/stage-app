			...
			<div class="modal-content">
				<form action="table.php" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Code-sexe</label>
							<select><type="text" class="form-control" name="sexe" required>
								<option>M</option>
						...
						<div class="form-group">
							...
							<input  type="date" class="date" name="deff" required>
						</div>
						<div class="form-group">
							<label>Lieu-effect</label>
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-success" value="Add" name="ajouter">
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<input type="submit" class="btn btn-info" value="Save" name="modifier">
					</div>
...
$resultat=mysqli_query($bdd,$req);
             ...
             ?>
						...
						<td><?php echo $row['1']; ?>p </td>
                        <td><?php echo $row['2']; ?>p </td>
                        <td><?php echo $row['3']; ?>p </td>
                        <td><?php echo $row['4']; ?>p </td>
                        <td><?php echo $row['5']; ?>p </td>
                        <td><?php echo $row['6']; ?>p </td><td>

                            <buttoan data-target="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>Modifier</button></td>
...
$leff=$_POST['leff'];
$bdd=mysqli_connect('localhost','root','','gestion des patients');
$req="insert into pers values($matricule,'$nom','$prenom',$code,'$cin',$deff,'$leff')";
$resultat=mysqli_query($bdd,$req);
...
//connection;
$bdd=mysqli_connect('localhost','root','','gestion des patients');
$req="update pers set matricule=$matricule,nom='$nom',prenom='$prenom',code=$code,cin='$cin',date_effect=$deff,lieu_effect='$leff')";
$resultat=mysqli_query($bdd,$req);
